...
class _MainAppState extends State<MainApp> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: Transform.translate(
              ...
              child: Transform.scale(
                ...
                child: ClipRRect(
                  ...
                  child: context.watch<MeModel>().isClient!
      ...
      bottomNavigationBar: context.watch<MeModel>().isClient!
          ? Transform.translate(
                      ...
                      (index) => GestureDetector(
                        ...
                        child: Column(
                          ...
                          children: [
                            AnimatedBar(
                                isActive:
                                    buttomNavs[index] == selectedBottomNav),
                            SizedBox(
                              height: 36,
                              width: 36,
                              child: Opacity(
                                opacity: buttomNavs[index] == selectedBottomNav
                                    ? 1
                                    : 0.5,
                                  ...
                                  onInit: (artboard) {
                                    StateMachineController controller =
                                        RiveUtils.getRiveController(artboard,
                                            stateMachineName: buttomNavs[index]
                                                .stateMachineName);
